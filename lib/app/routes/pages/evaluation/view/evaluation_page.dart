import 'package:expense_tracker/app/routes/pages/evaluation/blocs/bloc/selected_bloc.dart';
...
class PreviousDetails extends StatelessWidget {
...
class PreviousGraph extends StatelessWidget {
  const PreviousGraph({
    super.key,
  });
